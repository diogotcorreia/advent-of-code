...
for (let i = 0; i < 50000000000; i++) {
  ...
  if (result - lastResult === lastDifference) {
    lastResult += (50000000000 - i) * lastDifference;
    break;
  }
  lastDifference = result - lastResult;
  lastResult = result;
}

console.log("The answer is:");
console.log(lastResult);
console.timeEnd("12-part2");
